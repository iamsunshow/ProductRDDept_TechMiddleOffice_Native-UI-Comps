...
VISUALS = {
    ...
    "ui.cell": v_list_item, "ui.progress-circle": v_progress, "ui.refresh": v_refresh,
...
ORDER = [
    ...
    ("UI · 数据展示", "ui", ["ui.empty", "ui.list", "ui.cell", "ui.line-chart", "ui.progress-circle"]),
...
NAMES = {
    ...
    "ui.list": "列表 List", "ui.cell": "Cell 单元格",
