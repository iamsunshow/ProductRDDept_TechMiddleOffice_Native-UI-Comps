...
public enum AppColor {
    public static let primary = UIColor(hex: 0x16A34A)
    public static let primaryPressed = UIColor(hex: 0x15803D)
    public static let primaryMuted = UIColor(hex: 0xDCFCE7)
    public static let income = UIColor(hex: 0x16A34A)
    public static let expense = UIColor(hex: 0xDC2626)
    public static let error = UIColor(hex: 0xDC2626)
    public static let success = UIColor(hex: 0x16A34A)
    public static let gray4 = UIColor(hex: 0xF5F5F5)
    public static let gray6 = UIColor(hex: 0xE5E5E5)
    public static let gray10 = UIColor(hex: 0xD9D9D9)
    public static let gray15 = UIColor(hex: 0xBFBFBF)
    public static let gray25 = UIColor(hex: 0x8C8C8C)
    public static let warning = UIColor(hex: 0xF59E0B)
    public static let textPrimary = UIColor(hex: 0x111827)
    public static let textSecondary = UIColor(hex: 0x6B7280)
    ...
    /// v1.0.11 新增：BarChart 轨道灰底（与 Android AppColor.bgGrayLight 对齐；设计稿 0xF3F4F6）。
...
public enum AppFont {
    ...
    public static let sizeDisplay: CGFloat = 32
}
...
public enum AppSpace {
    ...
    public static let cellVertical: CGFloat = 16
}
...
public enum AppText {
    /// 相邻文本行间距。
    public static let lineSpacing = AppSpace.sm
    /// 段落块间距（如说明与列表之间）。
    public static let paragraphSpacing = AppSpace.md
    /// Compose 行高倍率。
    public static let lineHeightMultiple: CGFloat = 1.8

    /// 列表行(Cell)主标题行高，来自设计稿「32 号字 cell」：48px@2x = 24pt。
    public static let cellTitleLineHeight: CGFloat = 24
    /// 列表行(Cell)副标题行高，来自设计稿「32 号字 cell」：36px@2x = 18pt。
    public static let cellSubtitleLineHeight: CGFloat = 18
    ...
    public static func verticalCenterBaselineOffset(
        lineHeight: CGFloat,
        fontSize: CGFloat,
        font: UIFont? = nil
    ) -> CGFloat {
    ...
    public static func paragraphStyle(alignment: NSTextAlignment = .natural) -> NSParagraphStyle {
...
extension UILabel {
    ...
    public func setLineHeight(_ lineHeight: CGFloat, fontSize: CGFloat) {
