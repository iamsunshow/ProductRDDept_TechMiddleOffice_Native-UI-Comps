...
| ConfigProvider 全局配置 | 门禁 A/B/C1 ✅（2026-09-03）；双端实现完成：Android 15/15 绿 + iOS 模拟器实跑 15/15 绿；Demo Showcase 双端已加（2026-09-03 配置生效对比，编译通过，组件库 v1.2.1 基线） | 实机确认（门禁 C1.5）→ 发版 |
