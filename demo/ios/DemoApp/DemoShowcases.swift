...
final class DemoListViewController: UITableViewController {
    ...
    private let sections: [(category: String, components: [DemoComponent])] = [
        ("基础组件", [
            ...
            DemoComponent(id: "ui.overlay", name: "Overlay 遮罩层", reviewed: true, create: { OverlayShowcase() }, pending: true),
            DemoComponent(id: "ui.popup", name: "Popup 弹出层", reviewed: true, create: { PopupShowcase() }, pending: true),
        ]),
        ("布局组件", [
        ...
        ("数据录入", [
            ...
            DemoComponent(id: "ui.image-view", name: "ImageView 图片视图", reviewed: true, create: { ImageViewShowcase() }, passed: true),
            ...
            DemoComponent(id: "ui.picker-view", name: "PickerView 多列选择器", reviewed: true, create: { PickerViewShowcase() }, passed: true),
            ...
            DemoComponent(id: "ui.slider", name: "Slider 滑块", reviewed: true, create: { SliderShowcase() }, passed: true),
            DemoComponent(id: "ui.stepper", name: "Stepper 步进器", reviewed: true, create: { StepperShowcase() }, passed: true),
        ...
        ("特色组件", [
            ...
            DemoComponent(id: "ui.card", name: "Card 商品卡片", reviewed: false, create: nil, planned: true),
...
final class DropDownMenuShowcase: ShowcaseViewController {
    override func viewDidLoad() {
        super.viewDidLoad()
        addVersionBadge(componentName: "DropDown / DropDownMenu", version: "v1.7.8", builtAt: "2026-09-12")
