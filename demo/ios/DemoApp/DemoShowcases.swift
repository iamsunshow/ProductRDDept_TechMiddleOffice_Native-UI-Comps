...
final class DemoListViewController: UITableViewController {
    ...
    private let sections: [(category: String, components: [DemoComponent])] = [
        ...
        ("操作反馈", [
            ...
            DemoComponent(id: "ui.refresh", name: "PullToRefresh 下拉刷新", reviewed: true, create: { PullRefreshShowcase() }, passed: true),
            DemoComponent(id: "ui.swipe", name: "Swipe 滑动操作", reviewed: true, create: { SwipeShowcase() }, passed: true),
