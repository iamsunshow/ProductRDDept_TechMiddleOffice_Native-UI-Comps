...
//
//  设计意图（v2.0.10 修复 · 2026-09-16）：
//  TrendChartView v2.0.2 public 化时只 public 了类本身，漏 public 化参数类型
//  `ChartPoint` —— 导致任何按 public API 调用 apply(expensePoints: [ChartPoint], ...)
//  的代码（含 demo 与宿主 App）都被 Swift 严格模式判为「public 方法用 internal 类型」
//  而编译失败。v2.0.10 单独建本文件补齐，与 Android `data class ChartPoint(label, amount)`
