...
| A2 | Token 零硬编码 | ✅ | 壳 48/radius lg/底 bgPage 无边框、壳内 padding lg、放大镜 14 textSecondary 灰、文本 Md16 textPrimary/placeholder textSecondary、清除钮 20 灰底(E5E7EB)白叉、间距 sm、disabled 40% 灰=全走 token/已收编 Input #29 壳 token 锚定（radiusLg=14 对齐 FormFieldRow min48；库内无 textTertiary token=placeholder 用 textSecondary 同 Input #29 惯例） |
